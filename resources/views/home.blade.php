...
<body>
    ...
    {{-- <footer class="bg-footer">
        <div class="flex justify-between px-18 py-15">
            <div class="grid gap-y-12">
                <div class="grid gap-y-3">
                    ...
                    <p class="font-poppins text-secondary w-97 text-base leading-7 font-normal">Our mission is to make fashion accessible, stylish, and comfortable for everyone. We focus on delivering high-quality clothing that helps people express their unique style every day.</p>
                </div>
        ...
        <div class="items-center border-t border-white px-18 py-9">
